    ...
    <div ref={containerRef} className="h-full overflow-y-auto bg-white text-black selection:bg-black selection:text-white font-sans">
      ...
      <section className="relative w-full min-h-[60vh] sm:min-h-[85vh] flex flex-col justify-center border-b border-gray-200 bg-[#fafafa]">
        ...
        <div className="relative z-10 w-full max-w-[1400px] mx-auto px-4 sm:px-12 xl:px-24 text-center sm:text-left">
          <Reveal delay={100}>
            <div className="inline-flex items-center gap-2 px-3 py-1.5 text-[10px] font-black uppercase tracking-[0.2em] text-gray-500 border border-gray-300 mb-6 bg-white/70">
              <span className="w-1.5 h-1.5 bg-black rounded-full" />
              Loka Developer Platform
            </div>
            <h1 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-black tracking-[-0.035em] leading-[0.95] text-black max-w-4xl mx-auto sm:mx-0">
              One Skill.<br />
              Multi-Agent Analysis + <span className="text-gray-400">Global Payments.</span>
            </h1>
          </Reveal>
          ...
          <Reveal delay={200}>
            <p className="text-base sm:text-lg md:text-xl text-gray-500 font-medium leading-relaxed max-w-2xl mt-6 sm:mt-8 mx-auto sm:mx-0">
              Ship an AI-native fintech in a weekend. Four-agent analysis, 50+ payment rails, and sub-second risk scoring — all behind one API key.
            </p>
          </Reveal>
          ...
          <Reveal>
            <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-20">
              ...
              <h2 className="text-2xl sm:text-3xl md:text-5xl font-black text-black tracking-tight mb-6 leading-tight">
                Three APIs. One Workflow.<br />
                <span className="text-gray-400">Ask. Discuss. Invest.</span>
              </h2>
              <p className="text-gray-500 text-base sm:text-lg leading-relaxed">
                SuperAgent analyzes. Chats lets users debate with AI and each other. Invest executes in one click. Drop them in separately, or ship them as a single flow.
              </p>
            </div>
          </Reveal>
      ...
      {/* ── 1.7 Skill ── */}
      <section id="skill" className="bg-white border-b border-gray-200">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-12 xl:px-24 py-12 sm:py-20 lg:py-32">
          <Reveal>
            <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16">
              ...
              <h2 className="text-2xl sm:text-3xl md:text-5xl font-black text-black tracking-tight mb-6 leading-tight">
                The npm for AI agents.<br />
                <span className="text-gray-400">One line. New capability.</span>
              </h2>
              <p className="text-gray-500 text-base sm:text-lg leading-relaxed">
                Skills are self-contained capabilities — a signal engine, a research workflow, a data enricher. Install from the registry, or publish your own. Versioned, signed, audited.
              </p>
            </div>
          </Reveal>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-gray-200 border border-gray-200">
            {[
              { n: '01', title: 'Install', desc: 'One command adds a skill to your agent. No rebuild, no redeploy.', code: 'loka skill add last30days' },
              { n: '02', title: 'Invoke', desc: 'Call it from any chat or tool route. Skills expose a typed schema.', code: "agent.use('last30days')" },
              { n: '03', title: 'Publish', desc: 'Ship your own skill to the registry. Versioned, signed, auditable.', code: 'loka skill publish' },
            ].map(s => (
              <Reveal key={s.n} delay={100}>
                <div className="bg-white p-6 sm:p-10 h-full flex flex-col">
                  <div className="flex items-center gap-3 mb-6">
                    <div className="w-8 h-8 bg-black text-white text-[11px] font-black flex items-center justify-center">{s.n}</div>
                    <span className="text-[10px] font-black text-gray-400 uppercase tracking-widest">{s.title}</span>
                  </div>
                  ...
                  <code className="text-[11px] font-mono bg-gray-100 text-black px-2 py-1 border border-gray-200 block w-fit select-all">{s.code}</code>
                </div>
              </Reveal>
            ))}
          </div>
      ...
      <section id="sdk" className="border-b border-gray-200 flex flex-col lg:flex-row">
        ...
        <div className="lg:w-1/2 p-5 sm:p-12 lg:p-16 xl:p-24 border-b lg:border-b-0 lg:border-r border-gray-200 bg-white flex flex-col justify-center text-center sm:text-left">
          <Reveal>
            ...
            <h2 className="text-3xl sm:text-4xl font-black tracking-tight mb-4">Money in. Money out.<br /><span className="text-gray-400">190+ countries. One SDK.</span></h2>
            <p className="text-base text-gray-600 leading-relaxed mb-10 max-w-md mx-auto sm:mx-0">
              <strong>Coinbase</strong> + <strong>Onramper</strong> on the way in. <strong>MoonPay</strong> on the way out. Credit cards, bank transfers, Apple Pay, and local rails — without stitching together four vendors yourself.
            </p>
      ...
      <section id="api" className="bg-white border-b border-gray-200">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-12 xl:px-24 py-12 sm:py-20 lg:py-32">
          <Reveal>
            <h2 className="text-2xl sm:text-3xl md:text-5xl font-black tracking-tight mb-4 max-w-2xl text-center sm:text-left mx-auto sm:mx-0">Four APIs.<br /><span className="text-gray-400">Everything fintech needs.</span></h2>
        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-12 xl:px-24 py-12 sm:py-20 lg:py-32">
          <Reveal>
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <h2 className="text-2xl sm:text-3xl md:text-5xl font-black text-black tracking-tight mb-6 leading-tight">
                Fraud screened in 340ms.<br />
                <span className="text-gray-400">Not 34 seconds.</span>
              </h2>
              <p className="text-gray-500 text-base sm:text-lg leading-relaxed max-w-2xl mx-auto">
                Four validators — amount, identity, geography, velocity — run <strong className="text-black">in parallel</strong> on every transaction, then a consensus layer returns one unified score. Approve, challenge, or reject, at the speed of your checkout.
              </p>
            </div>
          </Reveal>
        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-12 xl:px-24 py-12 sm:py-20 lg:py-32">
          ...
          <Reveal>
            <div className="mb-12 text-center">
              <h2 className="text-2xl sm:text-3xl font-black tracking-tight mb-2">Shipped by fintechs, trading desks, and RWA platforms.</h2>
               <p className="text-gray-500 text-sm mb-8">Pick your use case. See the code that makes it real.</p>
        ...
        <div className="max-w-[1000px] mx-auto px-4 sm:px-12 py-12 sm:py-20 lg:py-32">
          <Reveal>
            <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-8 sm:mb-12 border-b border-black pb-4">
              <div>
                <h2 className="text-3xl font-black tracking-tight text-black">Every endpoint, one page.</h2>
                <p className="text-sm text-gray-500 mt-2">Standard JSON. OpenAPI 3.0. No surprises.</p>
              </div>
      ...
      {/* ── 5.5 Docs ── */}
      <section id="docs" className="bg-white border-b border-gray-200">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-12 xl:px-24 py-12 sm:py-20 lg:py-32">
          <Reveal>
            <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16">
              <div className="inline-flex items-center gap-2 px-4 py-2 text-[10px] font-bold uppercase tracking-[0.2em] text-gray-500 border border-gray-300 mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl md:text-5xl font-black text-black tracking-tight mb-6 leading-tight">
                Hello-world to production.<br />
                <span className="text-gray-400">In an afternoon.</span>
              </h2>
              <p className="text-gray-500 text-base sm:text-lg leading-relaxed">
                Quickstarts, API reference, and skill-authoring guides. All the docs you actually need — none of the filler.
              </p>
            </div>
          </Reveal>
          ...
          <Reveal delay={100}>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-px bg-gray-200 border border-gray-200">
              {[
                { label: 'Quickstart', desc: 'Install the CLI, create your first agent, ship in 5 minutes.', href: '#' },
                { label: 'API Reference', desc: 'Every endpoint, parameter, and return shape. OpenAPI 3.0.', href: '#' },
                { label: 'Skill Authoring', desc: 'Build, test, sign, and publish your own Loka Skill.', href: '#' },
                { label: 'SDK Guides', desc: 'Framework-level recipes for React, Node, and Python.', href: '#' },
              ].map(d => (
                <a
                  key={d.label}
                  href={d.href}
                  className="bg-white p-6 sm:p-8 flex flex-col hover:bg-gray-50 transition-colors group"
                >
                  <div className="flex items-center justify-between mb-4">
                    <span className="text-[10px] font-black text-gray-400 uppercase tracking-widest">{d.label}</span>
                    <svg className="w-4 h-4 text-gray-300 group-hover:text-black group-hover:translate-x-0.5 transition-all" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3"/></svg>
                  </div>
                  <h3 className="text-lg font-black mb-2">{d.label}</h3>
