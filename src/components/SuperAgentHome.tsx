...
// Web3PulseBanner extracted to ./home/Web3PulseBanner during Phase-2 refactor.
import { Web3PulseBanner, type AssetHint } from './home/Web3PulseBanner';
    ...
    return (
      <>
        ...
        <SuperAgentChat
          ...
          // Forward the explicit Stocks/Web3 page toggle. Backend trusts this
          // signal over the LLM router's guess so a small-cap A-share asked in
          // the Stocks tab won't be mis-routed to web3, and a long-tail token
          // (PENGU/ONDO/JUP/...) asked in the Web3 tab won't be sent into the
          // equity datasource pipeline. Only forwarded for new chats —
